...
--[[page/Tab]]
    ...
    local Library = Update:Window("Hieu Blox","",Enum.KeyCode.F1);
...
pcall(function()
    if _G.AutoKen then  
        if game:GetService("Players").LocalPlayer:FindFirstChild("PlayerGui") and game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("83653192991806") then
        else
            wait(1)
